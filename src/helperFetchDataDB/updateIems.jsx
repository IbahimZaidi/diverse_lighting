...
export const updateIems = async (
  ...
  const url = `http://localhost:3000/api/updateItem?array_colors=${arrayColorsString}&old_array_colorsString=${old_array_colorsString}&all_colors_arrayString=${all_colors_arrayString}&exempleLikImage=${exempleLikImage}&model_name=${model_name}&currentId=${currentId}&array_color_id=${array_color_id}`;
